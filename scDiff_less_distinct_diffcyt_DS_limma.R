...
out_diffcyt_DS_limma_less_distinct  <- 
  out_clusters_diffcyt_DS_limma_less_distinct <- 
...
names(out_diffcyt_DS_limma_less_distinct) <- 
  names(out_clusters_diffcyt_DS_limma_less_distinct) <- 
...
for (s in 1:length(rep_names)) {
  ...
  out_clusters_diffcyt_DS_limma_less_distinct[[s]] <- res_clusters
  ...
  # store results
  out_diffcyt_DS_limma_less_distinct[[s]] <- res
...
#out_diffcyt_DS_limma_less_distinct
#runtime_diffcyt_DS_limma_less_distinct
#out_clusters_diffcyt_DS_limma_less_distinct
#out_objects_diffcyt_DS_limma_less_distinct
